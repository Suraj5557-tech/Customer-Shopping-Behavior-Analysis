...
* [`Customer_Shopping_Behavior_Analysis_Presentation.pptx`](Customer_Shopping_Behavior_Analysis_Presentation.pptx) - Executive presentation deck for stakeholders.
